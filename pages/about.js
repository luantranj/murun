...
export default function About() {
	return (<>
		...
		<div className="col-12 col-md-9">
			...
			<p>You can reach me through <Link href={ "https://www.twitter.com/" + process.env.TWITTER_ACCOUNT }><a className="text-decoration-none">Twitter</a></Link>  whenever you feel like it, and I&apos;ll be sure to follow-up soon!</p>
		</div> { /* col: end */ }
	</div> { /* row: end */ }	
