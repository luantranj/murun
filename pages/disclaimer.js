		...
		<div className="container-md fs-5 mt-5">
			<div className="row justify-content-center px-2">
				<div className="col-12 col-md-9">
					...
					<Link href="https://www.amazon.com/"><a className="text-decoration-none"> Amazon</a></Link> Services LLC Associates Program,
					...
					<Link href="https://www.amazon.com/"><a className="text-decoration-none"> Amazon.com.</a></Link></p>
